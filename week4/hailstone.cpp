...
** Description: Returns the length of the hailstone sequence for an integer argument.
*********************************************************************/
...
// Takes an integer argument and returns the length of the hailstone sequence (not the sequence itself).
int hailstone(int stone)
{
